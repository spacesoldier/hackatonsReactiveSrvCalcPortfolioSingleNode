...
import com.spacesoldat.hackathons.web.WebCallParam;
import com.spacesoldat.hackathons.web.WebErrorStatusHandlers;
...
public class UserCatalogCallLogicImpl {
    ...
    public static Function<FindUserInCatalogRequest, List> prepareCallSpecImpl(WebClient client){
        return prepareCallRq -> {
            List results = new ArrayList();

            String rqPath = prepareCallRq.getUserLogin();
    ...
    public static Function<RunUserCatalogRequest, List> runCatalogCall(
