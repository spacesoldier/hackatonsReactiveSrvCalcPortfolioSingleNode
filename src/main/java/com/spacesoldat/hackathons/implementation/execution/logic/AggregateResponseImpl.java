...
public class AggregateResponseImpl {
    ...
    public static Function<ClientPortfolioResponse,String> sendResponseBodyForSuccessResult(MonoWiresManager monoManager){
        ...
        return response -> {
            ...
            monoManager.getInput(response.getRequestId())
                            .accept(
                                    gson.toJson(response.getSharesInPortfolio())
                            );
